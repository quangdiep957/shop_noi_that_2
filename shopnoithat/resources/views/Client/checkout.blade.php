                    ...
                    <div class="single-sidebar">
                        ...
                        @foreach($product3 as $product)
                            ...
                            <div class="product-inner-price">
                                <ins>{{$product->old_price}}</ins> <del>{{$product->price}}</del>
                            </div>                
                        </div>
                          @endforeach
                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                       ...
                       @endphp
                        ...
                        <form enctype="multipart/form-data" action="{{asset('client/checkout')}}" class="checkout" method="POST" name="checkout">
                                @csrf
                                @if($user!=null)
                                    ...
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                                ...
                                                <input type="text" value="{{$user['name']}}" placeholder="" id="billing_first_name" name="fullname" class="input-text ">
                                            </p>
                                            ...
                                            <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                                ...
                                                <input type="text" value="{{$user['phone']}}" placeholder="" id="billing_phone" name="phone" class="input-text ">
                                            </p>
                                            <div class="clear"></div>
                                            <p id="shipping_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                    <label class="" for="shipping_address_1">Address <abbr title="required" class="required" >*</abbr>
                                                    </label>
                                                    <input type="text" value="{{$user['address']}}" placeholder="Street address" id="address" name ="address" class="input-text ">
                                                </p>
                                                <p id="order_comments_field"  >
                                                <label class="" for="order_comments">Order Notes</label>
                                                <textarea style="border-width: 1px;color: #696763;" cols="5" rows="2" placeholder="Notes about your order, e.g. special notes for delivery." id="order_comments" class="input-text " name="comments"></textarea>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div id="order_review" style="position: relative;">
                                    ...
                                    @endphp
                                      ...
                                      @php $tong += $cart['price'] * $cart['quantity'];
                                        $tongsl+=$cart['quantity'];
                                        @endphp
                                        <input type ="hidden" value="{{$cart['id']}}" name ="cart_id"/>
                                        <input type ="hidden" value="{{$cart['quantity']}}" name ="quantity"/>
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                   {{$cart['name']}} <strong class="product-quantity"> X {{$cart['quantity']}}</strong> </td>
                                                <td class="product-total">
                                                    <span class="amount">{{number_format($cart['price']*$cart['quantity'])}}đ</span> </td>
                                            </tr>
                                         @endforeach
                                        </tbody>
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th>Cart Subtotal</th>
                                                <td><span class="amount">{{number_format($tong)}}đ</span>
                                                </td>
                                            </tr>
                                    ...
                                    <div id="payment">
                                        ...
                                        <input type ="hidden" value="{{number_format($tong)}}" name ="tongtien"/>
                                        <input type ="hidden" value="{{$tongsl}}" name ="tongsl"/>
