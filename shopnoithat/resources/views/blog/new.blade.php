    ...
    <div class="card-body card-block">
        ...
        <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="name" name="tieude" placehold="Text" class="form-control" require value="{{old('tieude')}}">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="name" name="email" placeholder="Text" class="form-control" require value="{{old('email')}}">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <textarea name="mota" id="textarea-input" rows="9" placeholder="Content..." class="form-control">{{old('mota')}}</textarea>
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
