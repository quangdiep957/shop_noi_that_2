        ...
        <table class='es-wrapper' width='100%' cellspacing='0' cellpadding='0' background='https://tlr.stripocdn.email/content/guids/CABINET_43f57cd17df7173735d2e390a6fa0296/images/98181605774448010.png' style='background-position: center top;'>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class='esd-structure es-p20' align='left' esd-custom-block-id='219798'>
                                                                                    ...
                                                                                    <td align='left' class='esd-block-text'>
                                                                                        <h1>
                                                                                            <font style='vertical-align: inherit;'>
                                                                                                <font style='vertical-align: inherit;'>
                                                                                                    <font style='vertical-align: inherit;'>
                                                                                                        <font style='vertical-align: inherit;'>Xin chào:{{$users['name']}} </font>
                                                                                                    </font>
                                                                                                </font>
                                                                                                <font style='vertical-align: inherit;'>
                                                                                                    <font style='vertical-align: inherit;'>
                                                        ...
                                                        <!--[if mso]></td><td width='20'></td><td width='202' valign='top'>
                                                        <table cellpadding='0' cellspacing='0' class='es-right' align='right'>
                                                            <tbody>
                                                                <tr>
            ...
            @php 
              ...
              @endphp        
                    ...
                    <td>{{$stt}}</td>
                    <td>{{$cart['name']}}</td>
                    <td><img src="{{asset('uploads')}}/{{$cart['id']}}.jpg"></td>
                    <td>{{$cart['quantity']}}</td>
                    <td>{{$cart['price']}}</td>
                    <td>{{$tong}}</td>
...
<form action="{{asset('confirm')}}/{{$orders[0]->id}}/1" method='GET'>
    @csrf
