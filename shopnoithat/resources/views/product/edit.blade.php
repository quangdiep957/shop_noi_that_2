...
<div class="card">
    ...
    <div class="card-body card-block">
        <form action="{{route('products.update',[$products->id])}}" method="post" enctype="multipart/form-data" class="form-horizontal">
        @method('PUT')
        @csrf
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="name" name="name" placeholder="Text" class="form-control" value="{{count($errors)?old('name'):$products->name}}">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="email-input" name="size" placeholder="size" class="form-control" value="{{count($errors)?old('size'):$products->size}}">
                </div>
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="disabled-input" name="price" placeholder="price"  class="form-control" required value="{{count($errors)?old('price'):$products->price}}">
                </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="disabled-input" name="old_price" placeholder="Disabled"  class="form-control" required value="{{count($errors)?old('old_price'):$products->old_price}}">
                </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="disabled-input" name="viewed" placeholder=""  class="form-control" required value="{{count($errors)?old('viewed'):$products->viewed}}">
                </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <textarea name="description" id="textarea-input" rows="9" placeholder="Content..." class="form-control">{{count($errors)?old('description'):$products->description}}</textarea>
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
