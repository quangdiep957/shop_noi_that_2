...
<ul>
    ...
    <div class="card-body card-block">
        <form action="{{route('customers.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
        @csrf
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="fullname" name="fullname" placeholder="Text" class="form-control" value="{{old('fullname')}}">
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
            ...
            <div class="form-group row">
                    ...
                    <input class="col-sm-10 form-control" name="DOB" placeholder="Năm sinh" value="{{old('DOB')}}"/>
                    
            </div>
            <div class="form-group row">
                    <label class="col-sm-2" for="address">Địa chỉ</label>
                    <input class="col-sm-10 form-control" name="address" placeholder="Địa chỉ" value="{{old('address')}}"/>
